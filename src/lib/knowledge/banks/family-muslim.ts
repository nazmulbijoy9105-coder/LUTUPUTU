...
const rules = [
  ...
  { id: "fam-prop-guardianship-001", title: "Guardianship of Property", source: "Guardians and Wards Act 1890 / Muslim Personal Law", rule: "A de facto guardian (such as a paternal uncle) has no legal authority to sell, alienate, or transfer a minor's immovable property without court permission. Any such unauthorized sale is void ab initio.", certainty: "confirmed" as const, religion: "muslim" as const },
  { id: "fam-muslim-succession-001", title: "Succession & Inheritance", source: "Muslim Personal Law (Shariat) Application Act 1937", rule: "Governed by Islamic Sharia. Property of the deceased is distributed among Quranic heirs and residuaries: Widow gets 1/8th if children exist, 1/4th if no children. Daughter gets half of son's share. Parents get 1/6th each if children exist.", certainty: "confirmed" as const, religion: "muslim" as const },

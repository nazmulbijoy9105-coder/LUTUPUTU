...
const rules = [
  ...
  { id: "fam-chr-002", title: "Christian Succession", source: "Indian Succession Act 1925", rule: "Governed by ISA 1925. Widow gets 1/3rd if children exist, 1/2nd if no children. Rest divided among children.", certainty: "confirmed" as const, religion: "christian" as const },
];
